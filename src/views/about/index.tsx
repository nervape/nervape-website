        ...
        <div className="about-container main-container">
            ...
            <section className="customizable-section">
                ...
                <div className="custom-cover">
                    <img loading="lazy" src={state.windowWidth > 750 ? SceneDragon : SceneDragonSmall} alt="SceneDragon" />
                </div>
                    ...
                    <div className="humans">
                        {humans.length ? (
                            humans.map((human, index) => {
                                return (
                                    <div
                                        className={`human ${state.windowWidth > 750 ? 'pc' : 'mobile'} ${currIndex === index && 'open'}`}
