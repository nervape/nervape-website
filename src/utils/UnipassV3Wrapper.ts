...
import { TransactionBuilderExpectedMNFTData } from './nft';
import { TransferNFTBuilder } from './TransferNFTBuilder';
...
const LinaCellDeps = [
    new CellDep(
        DepType.code,
        new OutPoint('0x5dce8acab1750d4790059f22284870216db086cb32ba118ee5e08b97dc21d471', '0x2')
    )
];
...
export class UnipassV3Wrapper {
    ...
    async bridgeMNFTS(
        ...
        const cellDeps = CONFIG.PW_CORE_CHAIN_ID === 0 ? LinaCellDeps : AggronCellDeps;
